...
import {View_Target_NP} from "../../../../../services/Admin/Name_Provider/admin_np_service";
...
const NpProfilePic = () => {
    ...
    useEffect(async () => {
        // console.log(npList);
        // console.log(npList.description);/
    }, [npList]);
