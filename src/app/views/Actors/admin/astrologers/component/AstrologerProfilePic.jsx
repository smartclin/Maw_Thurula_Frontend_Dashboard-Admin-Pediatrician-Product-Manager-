...
import {View_Target_Astrologer} from "../../../../../services/Admin/Astrologer/admin_astrologer_service";
...
const AstrologerProfilePic = () => {
    ...
    useEffect(async () => {
        ...
        // console.log(astrologerList.profile_picture);
    }, [astrologerList]);
            ...
            >
                <CardHeader sx={{  ml: 3 }}>
                    <Box
                        ...
                        alt="Picture not responded"
                        src={astrologerList.profile_picture}
                    />
                </CardHeader>
            </Grid>
...
export default AstrologerProfilePic;
