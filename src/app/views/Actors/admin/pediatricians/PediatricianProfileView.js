...
import PediatricianProfileViewStatCards from "./PediatricianProfileViewStatCards";
                ...
                <Grid container spacing={3}>
                    ...
                    <Grid item lg={4} md={4} sm={12} xs={12}>
                        <Card  sx={{ px: 3, py: 2, mb: 3 }}>
                            ...
                            <SubTitle>Pediatrician</SubTitle>
...
export default PediatricianProfileView;
